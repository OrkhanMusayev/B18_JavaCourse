 ...
 * It is important that you order your conditions so that your code will check for the special case endings of “ay”, “oy”, “ey”, and “uy” before simply checking whether a word ends in “y”.
 */
public class Pluralizer {
    ...
    public static void main(String[] args) {
        ...
        String result = "";
        String specialCaseEndings = word.substring(word.length()-2,word.length()-1);
        ...
        if(amt == 0 || amt > 1 ){
            ...
            }else if(word.substring(word.length()-1).equals("y") && !((specialCaseEndings.equals("a"))||specialCaseEndings.equals("o")||specialCaseEndings.equals("e")||specialCaseEndings.equals("u"))){
                result = word.replace("y","ies");

            }else if(word.endsWith("sh") || word.endsWith("ch")){
                result = word + "es";

            }else if(word.endsWith("us")){
                result = word.replace("us","i");
