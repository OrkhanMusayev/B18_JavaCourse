...
public class replit_034_VideoGameCoupon {

    public static void main(String[] args) {

        Scanner input = new Scanner(System.in);
        System.out.println("Enter number of coupons:");
        int numOfCoupon = input.nextInt();

        if(numOfCoupon >= 3){
            System.out.println("Number of Candies: " + (numOfCoupon / 10));
            System.out.println("Number of Gumballs: " + ((numOfCoupon % 10)/3));
        }else{
