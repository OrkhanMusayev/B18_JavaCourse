 ...
 * Write a program that assigns freeBooks the appropriate value based on the values of the boolean variable isPremiumCustomer and the int variable nbooksPurchased.
 * Print amount of freeBooks into the console.
 */
public class replit_080 {
