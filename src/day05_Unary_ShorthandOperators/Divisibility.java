...
public class Divisibility {
    ...
    public static void main(String[] args) {
        ...
        // if the number can be devided by 2 withoute any remainder,
        boolean divisibleBy3 = number % 3 == 0;
        // if the number can be devided by 3 withoute any remainder,
        boolean divisibleBy5 = number % 5 == 0;
        // if the number can be devided by 5 withoute any remainder,
        ...
        String result3 = number + " is divisible by 5: "+ divisibleBy5; // concatenation
