...
public class PostPre {
    ...
    public static void main(String[] args) {
        // PRE : changes the value of the variable immeditely
        ...
        double t1 = 3.5;
        double t2 = t1--; // 3.5 , after line34 t1 will be decreased by1
        System.out.println(t2); // 3.5
        System.out.println(t1); // 2.5

        int num = 35;
        System.out.println(num++); // 35, after line 39 the value of num will be 36
