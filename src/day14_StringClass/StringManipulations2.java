...
public class StringManipulations2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(   s1.equals(s2)    ); // true (when we compare two string(visible text) we should use equals NOT == sign)
        ...
        // ==
        System.out.println( z1 == z2 ); // false,because different memory location
        System.out.println(z2 == z3);  // false,because different memory location
